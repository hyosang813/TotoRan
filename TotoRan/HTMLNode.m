	...
	for(xmlAttrPtr attr = node->properties; NULL != attr; attr = attr->next)
	{
		...
		{				
			for(xmlNode * child = attr->children; NULL != child; child = child->next)
			{
				...
				//break;
                //よくわからんが上のbreakをコメントアウトすることでwarning回避してるらしい　「https://github.com/zootreeves/Objective-C-HMTL-Parser/issues/26」
			}
			break;
		}
	}
...
//同様に上のURL上でそのままreturnせずに一度NSStringの変数に入れて返すように修正したらこちらもwarning回避できてる
